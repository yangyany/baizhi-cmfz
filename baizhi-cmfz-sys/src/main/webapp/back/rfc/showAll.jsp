...
<script>
    ...
    $(function () {
        ...
        $da = $("#rfcdDa");
        $dg.datagrid({
            url:'${pageContext.request.contextPath}/rfc/queryAllRfcByPage',
            //fit:true,
            width:'100%',
            height:'100%',
            sortName:'id',
            ...
            columns: [[
                ...
                {title: "发表时间", field: "pushdate", width: 200, align: 'center'},
...
<div  class="easyui-layout" data-options="fit:true" >
    ...
    <div data-options="region:'center'," style="height: 30%;">
        <table id="rfcdDg" ></table>


        <div id="rfcdDa" style="height: 1%;"></div>
