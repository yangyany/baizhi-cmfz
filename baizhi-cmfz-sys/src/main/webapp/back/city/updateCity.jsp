...
<script>
    ...
    $(function(){
        //构建子页面元素的操作
        $("#cityUpdateForm").form('load','${pageContext.request.contextPath}/city/queryOneCity?id=${param.id}');
...
<div style="text-align: center;">
    <form id="cityUpdateForm" method="post">
        <div style="margin-top: 70px;">
            市编号:<input readonly="readonly" name="id" class="easyui-textbox" data-options="required:true"/><br/>
        </div>
